...
const FIELD_CATEGORIES = {
  general: {
    name: "General",
    fields: ["baseImage", "quantity", "customizableArea"],
  },
  scented: {
  ...
  square: {
    name: "Square Candles",
    fields: ["squareCandle", "addOns", "nameOnCandle"],
  },
  special: {
    name: "Special Candles",
    fields: ["specialCandle", "addOns", "nameOnCandle"],
  },
};
...
function AdminDashboard() {
  ...
  const handleTogglePublish = async (e, model) => {
    ...
    try {
      ...
      setModels((prev) =>
        prev.map((m) =>
          m.id === model.id ? { ...m, is_published: res.data.is_published } : m,
        ),
      );
    } catch (err) {
      ...
      setModels((prev) =>
        prev.map((m) =>
          m.id === configuringModel.id
            ? { ...m, admin_config: res.data.admin_config }
            : m,
        ),
      );
  ...
  return (
    <div className="admin-dashboard">
      ...
      <div className="admin-stats">
        ...
        <div className="stat-card">
          <span className="stat-num">
            {models.filter((m) => m.is_published).length}
          </span>
          ...
          {models.map((model) => (
            ...
            >
              <div className="product-card-image">
                ...
                <span
                  className={`publish-badge ${model.is_published ? "published" : "draft"}`}
                >
              ...
              <div className="product-card-body">
                ...
                <div className="product-card-price">
                  $ {parseFloat(model.base_price || 0).toFixed(2)}
                </div>
              </div>
            ...
            <div className="modal-body">
              ...
              <div className="modal-field">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewModel({ ...newModel, base_price: e.target.value })
                  }
                />
              </div>
              <div className="modal-field">
      ...
      {showConfigModal && (
        ...
        >
          <div
            className="create-modal config-modal"
          ...
          >
            ...
            <div className="modal-body">
              <p className="config-instructions">
                Select which customization fields users can edit. Only selected
                fields will be shown in the product configurator.
              </p>
